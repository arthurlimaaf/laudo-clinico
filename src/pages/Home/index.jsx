...
const Home = () => {
    ...
    const EditLaudo2 = (nome2, idade2, registro2, unidade2, data_coleta2, adequabilidade2, epitelios2, microbiologia2, atipias2, conclusao2) => {
        navigate("/edit-sem-alteracoes", { state: { nome2, idade2, registro2, unidade2, data_coleta2, adequabilidade2, epitelios2, microbiologia2, atipias2, conclusao2 } });
    }

    const LaudoPDFSemAlteracoes = (nome2, idade2, registro2, unidade2, dataFormatada, adequabilidade2, epitelios2, microbiologia2, atipias2, conclusao2) => {
        navigate("/laudo-pdf-sem-alteracoes", { state: { nome2, idade2, registro2, unidade2, dataFormatada, adequabilidade2, epitelios2, microbiologia2, atipias2, conclusao2 } });
    }
                                ...
                                <TableBody>
                                    {data2.map((data, index2, dataInicial, dataCriada, dataFormatada) => (
                                        ...
                                        <TableRow key={index2}>
                                            ...
                                            <TableCell align="right">{dataFormatada}</TableCell>
                                            <TableCell align="right"><ButtonEdit onClick={() => EditLaudo2(data.nome2, data.idade2, data.registro2, data.unidade2, data.data_coleta2, data.adequabilidade2, data.epitelios2, data.microbiologia2, data.atipias2, data.conclusao2)} Text="Editar" /></TableCell>
                                            <TableCell align="right"><ButtonExcluir onClick={() => handleDelete2(data.id_paciente2)} Text="Excluir" /></TableCell>
                                            <TableCell align="right"><ButtonPDF Text="PDF" onClick={() => LaudoPDFSemAlteracoes(data.nome2, data.idade2, data.registro2, data.unidade2, dataFormatada, data.adequabilidade2, data.epitelios2, data.microbiologia2, data.atipias2, data.conclusao2)} /></TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
